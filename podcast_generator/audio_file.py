...
def generate_audio(text, language, duration, voice, gemini_api_key, elevenlabs_api_key):
    ...
    response = dict({"audio_url":"D:/gen_ai applications/7_podcast/"+audio_path,"status_code":200})
    #response = dict({"audio_url":"D:/gen_ai applications/7_podcast/static/audio/podcast.mp3","status_code":200})
    return response
